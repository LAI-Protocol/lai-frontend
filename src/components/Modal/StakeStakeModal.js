        ...
        >
            ...
            <Modal.Body>
                <DepositCard height="211px">
                    ...
                    <TokenCard symbol="LAO" name="LAO" />
                </DepositCard>
                <HorizontalText mt="0" fontSize="25px" name="Collateral ratio" value="1202.0340 LAO"/>
            </Modal.Body>
            <Modal.Footer>
...
export default StakeStakeModal;